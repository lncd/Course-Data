...
class Dummy_data_model extends CI_Model {
	...
	*/
	function lincoln_g403()
	{
		...
		$courses['distanceLearningOnly'] = 'no';
		$courses['employmentDetailsURL'] = '';
		$courses['feeWaiver'] = 'no';
		$courses['feesConfirmation'] = 'yes';
		...
		$courses['meansTestedSupport'] = 'yes';
		$courses['partTimeOnly'] = 'no';
		...
		$courses['teacherTraining'] = 'no';
		$courses['ucasProgrammeCode'] = 'G403';
		$courses['variableFee'] = 'no';
	...
	*/
	function lincoln_p500()
	{
		...
		$course1['distanceLearningOnly'] = 'no';
		$course1['employmentDetailsURL'] = '';
		$course1['feeWaiver'] = 'no';
		$course1['feesConfirmation'] = 'yes';
		...
		$course1['meansTestedSupport'] = 'yes';
		$course1['partTimeOnly'] = 'no';
		...
		$course1['teacherTraining'] = 'no';
		$course1['ucasProgrammeCode'] = 'P500';
		$course1['variableFee'] = 'no';
	...
	*/
	function lincoln_g500()
	{
		...
		$course2['distanceLearningOnly'] = 'no';
		...
		$course2['feeWaiver'] = 'no';
		$course2['feesConfirmation'] = 'yes';
		...
		$course2['meansTestedSupport'] = 'yes';
		$course2['partTimeOnly'] = 'no';
		...
		$course2['teacherTraining'] = 'no';
		$course2['ucasProgrammeCode'] = 'G500';
		$course2['variableFee'] = 'no';
	...
	*/
	function lincoln_g401()
	{
		...
		$course3['meansTestedSupport'] = 'yes';
		$course3['partTimeOnly'] = 'no';
		...
		$course3['teacherTraining'] = 'no';
		$course3['ucasProgrammeCode'] = 'G401';
		$course3['variableFee'] = 'no';
	...
	*/
	function lincoln_d490()
	{
		...
		$course['distanceLearningOnly'] = 'no';
		...
		$course['meansTestedSupport'] = 'yes';
		$course['partTimeOnly'] = 'no';
		...
		$course['teacherTraining'] = 'no';
		$course['ucasProgrammeCode'] = 'D490';
		$course['variableFee'] = 'no';
	...
	*/
	...
	if(isset($attributes) AND $get_attributes) {
		foreach($attributes as $attr => $value ) {
			if($priority === 'tag') $attributes_data[$attr] = $value ;
		else $result['attr'][$attr] = $value ; //Set all the attributes in a array called 'attr'
		}
	}
